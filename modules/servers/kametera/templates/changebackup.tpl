<div class="card">
    <div class="card-body">
        <h3 class="card-title">Backup Subscription</h3>
        <div style="color: red;">Do you wish to change backup settings? If yes, click the button below to see available options.</div>
        <hr>
