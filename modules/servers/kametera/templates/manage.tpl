...
{/if}
<hr>
<h2>Service Actions <span style="font-size: 13px; float: right;">Server Power Status: <strong class="badge badge-success" {if $power == "off"}style="background-color: red;"{else}style="background-color: #4caf50;"{/if}>{$power}</strong></span></h2>
