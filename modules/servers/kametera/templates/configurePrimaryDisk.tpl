...
<div class="card">
    <div class="card-body">
        <h3 class="card-title">Configure Primary Disk</h3>
        <div>Do you wish to resize your primary disk? If yes, click the button below to see available options.</div>
        <br/>
        <div style="color: red; font-size: 0.8rem;">Caution: This operation will remove all existing snapshots and create new one.</div>
        <hr>
