...
<div class="card">
    <div class="card-body">
        <h3 class="card-title">Configure Secondary Disk B</h3>
        <ul>
          <li>
            If you don't have Disk B, this operation will attach a new Disk B in your server.
          </li>
          <li>
            If you already have Disk B, this operation will resize Disk B.
          </li>
          <li>
